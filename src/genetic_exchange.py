...
Genetic Exchange
------
Contained herein are methods for
exchanging genes between animaris.
"""
import bge
import random
...
class GeneticExchange2D:
    ...
    def __init__(self):
        ...
        for i in range(0, N_SURVIVORS):
            ...
            geneFile = open(bge.logic.expandPath("//Gen" + GENERATION + "\\" + str(num) + ".csv"), 'w')
